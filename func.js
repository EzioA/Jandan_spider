...
function hello()
{
	var a = "123".substr(0,1);
	var a = hex_md5("123");
	var p = hex_md5("oiXqcqIlsGXEYVyyW5zGMcwhqCxpHim5".substr(0, 16));
	var a = base64_decode("13");
...
//        u += chr(ord(l[h]) ^ (k[(k[q] + k[g]) % 256]))
		u += String.fromCharCode((l[h]).charCodeAt(0) ^ (k[(k[q] + k[g]) % 256]))
    }
    if (f == "DECODE") {
...
function jandan_load_img(img_hash) {
//    var d = $(b);
//    var f = d.next("span.img-hash");
    var e = img_hash;
//    f.remove();
    var c = jd16K92Q8ZNbu6FA7LfBJwNJUpmKRm5NV7(e, "oiXqcqIlsGXEYVyyW5zGMcwhqCxpHim5");
